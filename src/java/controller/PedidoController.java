...
public class PedidoController implements Serializable {
    ...
    @EJB
    private dao.PedidoFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("recursos/Bundle").getString("PedidoCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("recursos/Bundle").getString("PedidoUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("recursos/Bundle").getString("PedidoDeleted"));
        if (!JsfUtil.isValidationFailed()) {
        ...
        if (selected != null) {
            ...
            try {
                ...
                if (msg.length() > 0) {
                    ...
                    JsfUtil.addErrorMessage(ex, ResourceBundle.getBundle("recursos/Bundle").getString("PersistenceErrorOccured"));
                }
            } catch (Exception ex) {
