...
public class ProductoController implements Serializable {
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("recursos/Bundle").getString("ProductoCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("recursos/Bundle").getString("ProductoUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("recursos/Bundle").getString("ProductoDeleted"));
        if (!JsfUtil.isValidationFailed()) {
